# OSCAL SSP control implementation template

Use this template for `implemented-requirements` and control implementation statements.
...
- Source IDs:
- Evidence references:
- Mapping status: `mapped` | `needs_review` | `unmapped`

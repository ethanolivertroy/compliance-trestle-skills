...
Download the NIST SP 800-53 Rev 5 OSCAL catalog and a FedRAMP Rev 5 baseline profile.
Cache them locally.
Import both into a Compliance Trestle workspace.
...
- FedRAMP Rev 5 baseline profiles: `OSCAL-Foundation/fedramp-resources` on GitHub. See [fedramp.gov Rev 5 documents and templates](https://www.fedramp.gov/rev5/documents-templates/). OSCAL packages are managed through the FedRAMP automation GitHub ecosystem.
...
- Downloaded content is official NIST and FedRAMP OSCAL data.
- Do not edit it in place. Tailor through profiles.

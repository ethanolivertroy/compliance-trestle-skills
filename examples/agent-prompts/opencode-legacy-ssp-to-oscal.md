# OpenCode Prompt: Legacy SSP to OSCAL

Read `OPENCODE.md` and `AGENTS.md`, then perform this task.
...
Map any Claude slash-command references to the underlying shell scripts.
